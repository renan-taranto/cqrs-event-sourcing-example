...
/**
 * Class BoardTitleChangedPublisher
...
class BoardTitleChangedPublisher
{
    ...
    /**
     * BoardTitleChangedPublisher constructor.
    ...
    /**
     * @param BoardTitleChanged $boardTitleChanged
     */
    public function __invoke(BoardTitleChanged $boardTitleChanged): void
    {
        $this->ssePublisher->publish($this->boardsSseUrl, json_encode([
            'eventType' => $boardTitleChanged->eventType(),
            'payload' => [
                'id' => (string) $boardTitleChanged->aggregateId(),
                'title' => (string) $boardTitleChanged->title()
            ]
        ]));
    }
}
