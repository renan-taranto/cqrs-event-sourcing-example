...
final class ReorderListHandler
{
    ...
    /**
     * ReorderListHandler constructor.
    ...
    /**
     * @param ReorderList $command
     * @throws ListNotFound
     */
    public function __invoke(ReorderList $command): void
    {
        ...
        $list->reorder($command->toPosition());
