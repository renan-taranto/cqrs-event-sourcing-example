...
/**
 * Class ItemDoesNotExistValidator
 * @package Taranto\ListMaker\Item\Infrastructure\Validation
 * @author Renan Taranto <renantaranto@gmail.com>
 */
final class ItemDoesNotExistValidator extends ConstraintValidator
{
    ...
    /**
     * ItemDoesNotExistValidator constructor.
    ...
    {
        if (!$constraint instanceof ItemDoesNotExist) {
            throw new UnexpectedTypeException($constraint, ItemDoesNotExist::class);
        }
