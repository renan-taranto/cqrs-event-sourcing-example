...
/**
 * Class MongoDocumentExistsValidator
 * @package Taranto\ListMaker\Shared\Infrastructure\Validation\Constraints
 * @author Renan Taranto <renantaranto@gmail.com>
 */
class MongoDocumentExistsValidator extends ConstraintValidator
{
    /**
    ...
    {
        if (!$constraint instanceof MongoDocumentExists) {
            throw new UnexpectedTypeException($constraint, MongoDocumentExists::class);
        }
